export const nftContractAbi = [
  ...
  {
    inputs: [],
    name: 'WhiteListSaleNotAvailable',
    type: 'error',
  },
  {
    inputs: [],
    name: 'YouAlreadyMintedForTeam',
    type: 'error',
  },
  {
    inputs: [],
    name: 'YouAreNotWhiteList',
    type: 'error',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      {
        indexed: true,
        internalType: 'enum BimkonEyes.SalePhase',
        name: '_status',
        type: 'uint8',
      },
    ],
